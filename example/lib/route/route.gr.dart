...
import 'package:example/pages/mainpage/mainpage_view.dart' as _i2;
import 'package:example/pages/onboarding/onboarding_view.dart' as _i3;
import 'package:example/pages/signin/signin_view.dart' as _i4;
import 'package:example/pages/signup/signup_view.dart' as _i5;
import 'package:example/pages/splash/splash_view.dart' as _i6;
import 'package:example/pages/verifiticion/verification_view.dart' as _i7;
...
/// generated route for
/// [_i2.MainpageView]
class MainpageViewRoute extends _i8.PageRouteInfo<MainpageViewRouteArgs> {
  MainpageViewRoute({
    _i9.Key? key,
    int? pageNo,
  ...
  static _i8.PageInfo page = _i8.PageInfo(
    ...
    builder: (data) {
      ...
      return _i2.MainpageView(key: args.key, pageNo: args.pageNo);
    },
  );
}
...
/// generated route for
/// [_i6.SplashView]
class SplashViewRoute extends _i8.PageRouteInfo<SplashViewRouteArgs> {
  SplashViewRoute({
    _i9.Key? key,
    String? logoPath,
    String? splashText,
...
/// generated route for
/// [_i7.VerificationView]
class VerificationViewRoute extends _i8.PageRouteInfo<void> {
  const VerificationViewRoute({List<_i8.PageRouteInfo>? children})
  ...
  static _i8.PageInfo page = _i8.PageInfo(
    name,
    builder: (data) {
      return const _i7.VerificationView();
    },
  );
}
