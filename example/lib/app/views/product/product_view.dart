...
import 'package:example/core/cubits/product/product_state.dart';
import 'package:example/core/cubits/product_detail/product_detail_cubit.dart';
import 'package:example/core/cubits/product_detail/product_detail_state.dart';
  ...
  Widget _buildProductInfo(ProductDetailLoaded state, dynamic product) {
    return Padding(
      ...
      child: ProductInfoLabel(
        rating: state.productDetail.rate.toStringAsFixed(1),
